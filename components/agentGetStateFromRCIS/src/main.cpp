...
/** \mainpage RoboComp::agentGetState
 *
 * \section intro_sec Introduction
 *
 * The agentGetState component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agentGetState --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agentGetState : public RoboComp::Application
{
public:
	agentGetState (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::agentGetState::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
