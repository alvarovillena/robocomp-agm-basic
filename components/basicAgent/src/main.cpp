...
/** \mainpage RoboComp::basicAgent
 *
 * \section intro_sec Introduction
 *
 * The basicAgent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/basicAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class basicAgent : public RoboComp::Application
{
public:
	basicAgent (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::basicAgent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
